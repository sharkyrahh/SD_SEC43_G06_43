...
import com.example.smartparkparkingsystem.ParkingSlot;
import com.example.smartparkparkingsystem.R;
import com.example.smartparkparkingsystem.StatusActivity;
import com.example.smartparkparkingsystem.slotsAdapter;
...
public class StatusAdminActivity extends AppCompatActivity implements slotsAdapter.Listener{
    ...
    private void loadParkingSlotsFromFirebase() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(StatusAdminActivity.this,
